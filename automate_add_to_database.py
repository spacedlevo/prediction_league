        ...
        for row in csvreader:
            ...
            if existing_prediction:
                if (
                    ...
                    c.execute(
                        """ UPDATE predictions SET home_goals = ?, away_goals = ? WHERE player_id = ? AND fixture_id = ? """,
                        (home_goals, away_goals, user_id, fixture_id),
                    )
                    logging.info(
                ...
                if not existing_prediction:
                    c.execute(
                        """ INSERT INTO predictions (player_id, fixture_id, home_goals, away_goals) VALUES (?, ?, ?, ?)""",
